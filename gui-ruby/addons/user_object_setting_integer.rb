class UserObjectSettingInteger
	def gui_build_editor
		...
		@minus_button = GuiButton.new.set(:scale_x => 0.07, :scale_y => 0.32, :offset_x => -0.5 + 0.15 + 0.035, :offset_y => 0.15, :background_image => $engine.load_image('images/buttons/minus.png'))
