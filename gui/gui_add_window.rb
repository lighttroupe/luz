...
private
	...
	def create!
		...
		self << (@title = GuiLabel.new.set({:string => '', :width => 30, :offset_x => 0.19, :offset_y => 0.3, :scale_x => 0.58, :scale_y => 0.1}))
		self << (@description = GuiLabel.new.set({:string => '', :width => 30, :color => [1.0,1.0,1.0], :offset_x => 0.19, :offset_y => 0.2, :scale_x => 0.58, :scale_y => 0.06}))
		self << (@hint = GuiLabel.new.set({:string => '', :width => 30, :color => [0.7,0.7,0.7], :offset_x => 0.19, :offset_y => 0.1, :scale_x => 0.58, :scale_y => 0.06}))
