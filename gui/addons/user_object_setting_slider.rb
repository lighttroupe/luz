class UserObjectSettingSlider
	...
	def gui_build_editor
		...
		box << (input_min=GuiFloat.new(self, :input_min, 0.0, 1.0, digits=2).set(:text_align => :center, :width => 3, :scale_x => 0.07, :scale_y => 0.6, :offset_y => 0.0, :float => :left))
		box << (input_max=GuiFloat.new(self, :input_max, 0.0, 1.0, digits=2).set(:text_align => :center, :width => 3, :scale_x => 0.07, :scale_y => 0.6, :offset_y => 0.0, :float => :left))
		...
		box << (output_min=GuiFloat.new(self, :output_min, 0.0, 1.0, digits=2).set(:text_align => :center, :width => 3, :scale_x => 0.07, :scale_y => 0.6, :offset_y => 0.0, :float => :left))
		box << (output_max=GuiFloat.new(self, :output_max, 0.0, 1.0, digits=2).set(:text_align => :center, :width => 3, :scale_x => 0.07, :scale_y => 0.6, :offset_y => 0.0, :float => :left))
