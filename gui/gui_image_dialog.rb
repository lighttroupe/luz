class GuiImageDialog < GuiFileDialog
	def create!
		...
		self << @images_grid = GuiGrid.new.set(:min_columns => 5, :scale_x => 0.6, :scale_y => 0.5, :offset_x => 0.19, :offset_y => 0.1, :spacing_x => 0.2, :spacing_y => 0.1, :item_scale_x => 0.9, :item_scale_y => 0.8)
	end
