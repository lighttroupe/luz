...
class EventInputSliderSegmentedDown < EventInput
	title				"Slider Segmented Down"
	description "Activates each time slider crosses a boundary of one of a chosen number of segments going down."
