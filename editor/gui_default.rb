...
class GuiDefault < GuiBox
	...
	def create_default_gui
		self << (@actor_list = GuiList.new($engine.project.actors).set(:scale_x => 0.2, :scale_y => 1.0, :offset_x => -0.4, :offset_y => 0.4, :spacing_y => -1.0))

		self << (@curves_list = GuiList.new($engine.project.curves).set(:scale_x => 0.08, :scale_y => 0.25, :offset_x => -0.11, :offset_y => 0.40, :spacing_y => -1.0))
		self << (@themes_list = GuiList.new($engine.project.themes).set(:scale_x => 0.08, :scale_y => 0.5, :offset_x => 0.06, :offset_y => 0.4, :hidden => true, :spacing_y => -1.2))
		...
		self << (@variables_list = GuiList.new($engine.project.variables).set(:scale_x => 0.08, :scale_y => 0.5, :offset_x => 0.23, :offset_y => 0.4, :hidden => true, :spacing_y => -1.2))
		...
		self << (@events_list = GuiList.new($engine.project.events).set(:scale_x => 0.08, :scale_y => 0.5, :offset_x => 0.40, :offset_y => 0.4, :hidden => true, :spacing_y => -1.2))
